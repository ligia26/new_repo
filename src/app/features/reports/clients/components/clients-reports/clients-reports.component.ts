...
export class ClientsReportsComponent implements OnInit{
  ...
  reportTypes = [
    {value: 'cancel-clients', viewValue: 'Anulări clienți'},
  ];
  ...
  applyFilter(){
    ...
    if ((this.actualFilter.filterType === 'cancel-clients') && this.actualFilter.filterStartDate === '') {
      this.urlSafe=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/CanceledSaleReport' + this.actualFilter.filterTime + '.html';
      ...
      this.urlSafe =
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/CanceledSaleReport' + this.actualFilter.filterTime + 'Param.html?startDate='
      ...
      this.urlToDownload=
          ...
          // +  this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
          // + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
          this.baseUrl + this.actualFilter.filterTime + 'Param.pdf?startDate='
          +  this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
          + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
    }
  }
