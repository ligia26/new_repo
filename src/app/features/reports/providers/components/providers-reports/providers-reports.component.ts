...
export class ProvidersReportsComponent {
  ...
  reportTypes = [
    ...
    {value: 'top-10-best-sales', viewValue: 'Top 10 provideri - Resurse consumate'},
    {value: 'top-10-less-sales', viewValue: 'Top 10 provideri - Resurse neconsumate'},
  ...
  applyFilter(){
    ...
    if (this.actualFilter.filterType === 'all-sales') {
      console.log('test 0');
      this.urlSafe=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/ProviderSalesReport' + this.actualFilter.filterTime + '.html';
      this.urlToDownload=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/ProviderSalesReport' + this.actualFilter.filterTime + '.pdf';
    } else if ((this.actualFilter.filterType === 'top-10-best-sales') && (this.actualFilter.filterStartDate === '') && (this.actualFilter.filterDomain === '')) {
        console.log('test 1')
      this.urlSafe =
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/TopDomainSaleReport' + this.actualFilter.filterTime + '.html';
      this.urlToDownload =
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/TopDomainSaleReport' + this.actualFilter.filterTime + '.pdf';
    } else if ((this.actualFilter.filterType === 'top-10-less-sales') && (this.actualFilter.filterStartDate === '') && (this.actualFilter.filterDomain === '')) {
      console.log('test 2')
      this.urlSafe =
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/LeastDomainSaleReport' + this.actualFilter.filterTime + '.html';
      this.urlToDownload =
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/LeastDomainSaleReport' + this.actualFilter.filterTime + '.pdf';
    } else if ((this.actualFilter.filterType === 'top-10-best-sales') && (this.actualFilter.filterStartDate !== '') && (this.actualFilter.filterDomain !== '')) {
      this.urlSafe =
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/TopDomainSaleReport' + this.actualFilter.filterTime + 'Param.html?'
          + 'domain=' + this.actualFilter.filterDomain
          + '&startDate=' + this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
          + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
      this.urlToDownload =
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/TopDomainSaleReport' + this.actualFilter.filterTime + 'Param.pdf?'
          + 'domain=' + this.actualFilter.filterDomain
          + '&startDate=' + this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
          + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
    } else if ((this.actualFilter.filterType === 'top-10-less-sales') && (this.actualFilter.filterStartDate !== '') && (this.actualFilter.filterDomain !== '')) {
        this.urlSafe =
            this.baseUrl + '/jasperserver/rest_v2/reports/reports/LeastDomainSaleReport' + this.actualFilter.filterTime + 'Param.html?'
            + 'domain=' + this.actualFilter.filterDomain
            + '&startDate=' +  this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
            + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
        this.urlToDownload=
            this.baseUrl + '/jasperserver/rest_v2/reports/reports/LeastDomainSaleReport' + this.actualFilter.filterTime + 'Param.pdf?'
            + 'domain=' + this.actualFilter.filterDomain
            + '&startDate=' +  this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
            + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
      }
