...
export class SalesPerProviderComponent implements OnInit{
  ...
  filterStartDate = new Date(new Date().setDate(this.filterEndDate.getDate() - 30));
  filterTime = 'Daily';
  ...
  applyFilter(){
    ...
    if (this.actualFilter.filterType === 'all-sales') {
      this.urlSafe=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/ProviderSalesReport' + this.actualFilter.filterTime + 'Param.html?providerId=' + this.providerId
      ...
      this.urlToDownload=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/ProviderSalesReport' + this.actualFilter.filterTime + 'Param.pdf?providerId=' + this.providerId
          + '&startDate=' +  this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
          + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
    } else if (this.actualFilter.filterType === 'all-resources') {
      this.urlSafe=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/ResourceSalesReport' + this.actualFilter.filterTime + 'Param.html?providerId=' + this.providerId
          + '&startDate=' +  this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
          + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
      this.urlToDownload=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/ResourceSalesReport' + this.actualFilter.filterTime + 'Param.pdf?providerId=' + this.providerId
          + '&startDate=' +  this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
          + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
    } else if (this.actualFilter.filterType === 'domain-sales') {
      this.urlSafe=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/DomainSalesReport' + this.actualFilter.filterTime + 'Param.html?providerId=' + this.providerId
          + '&startDate=' +  this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
          + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
      this.urlToDownload=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/DomainSalesReport' + this.actualFilter.filterTime + 'Param.pdf?providerId=' + this.providerId
          + '&startDate=' +  this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
          + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
    }
  }
