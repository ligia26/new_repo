...
export class ResourcesReportsComponent {
  ...
  applyFilter(){
    ...
    if (this.actualFilter.filterType === 'all-resources') {
      this.urlSafe=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/ResourceSalesReport' + this.actualFilter.filterTime + '.html';
      this.urlToDownload=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/ResourceSalesReport' + this.actualFilter.filterTime + '.pdf';
    } else if (this.actualFilter.filterType === 'domain-sales') {
      this.urlSafe =
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/DomainSalesReport' + this.actualFilter.filterTime + '.html';
      this.urlToDownload=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/DomainSalesReport' + this.actualFilter.filterTime + '.pdf';
    } else if ((this.actualFilter.filterType === 'top-10-resources') && this.actualFilter.filterStartDate === '') {
      this.urlSafe =
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/TopResourceTypeSalesReport' + this.actualFilter.filterTime + '.html';
      this.urlToDownload=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/TopResourceTypeSalesReport' + this.actualFilter.filterTime + '.pdf';
    } else if ((this.actualFilter.filterType === 'top-10-resources') && this.actualFilter.filterStartDate !== '') {
      this.urlSafe =
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/TopResourceTypeSalesReport' + this.actualFilter.filterTime + 'Param.html?startDate='
      ...
      this.urlToDownload=
          this.baseUrl + '/jasperserver/rest_v2/reports/reports/TopResourceTypeSalesReport' + this.actualFilter.filterTime + 'Param.pdf?startDate='
          +  this.datepipe.transform(this.actualFilter.filterStartDate, 'yyyy-MM-dd')
          + '&endDate=' + this.datepipe.transform(this.actualFilter.filterEndDate, 'yyyy-MM-dd');
    }
  }
